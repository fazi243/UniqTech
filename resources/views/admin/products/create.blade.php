                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel"
                                ...
                                <div class="col-md-12 my-3">
                                    ...
                                    <select name="category_id" class="form-control rounded border border-secondary">
                                ...
                                <div class="col-md-12 mb-3">
                                    <label for="" class="form-label">Category</label>
                                    <select name="brand_id" class="form-control rounded border border-secondary">
                            ...
                            <div class="tab-pane fade" id="seotag-tab-pane" role="tabpanel" aria-labelledby="seotag-tab"
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea name="meta_keyword" class="form-control rounded border border-secondary"
                            ...
                            <div class="tab-pane fade" id="details-tab-pane" role="tabpanel"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="trending" class="form-control rounded border border-secondary">
                                        <option selected disabled>Select Trending Status</option>
